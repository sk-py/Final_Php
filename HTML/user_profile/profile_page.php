...
<body>
    <div class="container rounded bg-white shadow-lg mt-md-5 ">
                    ...
                    <div class="d-flex align-items-center justify-content-center">
                        <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-3 border-right w-100 text-center">
                                    <div
                                        ...
                                        <img style="border-radius: 50%;height:160px;object-fit: cover;width:160px;border:1px solid black"
                                            id="profile-image" src="../../default_img.png" accept=""
                                            maxFileSize="1048576">
                            ...
                            class="text-black-50">edogaru@mail.com.my</span><span>
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-6"><label class="labels fs-6">Name</label>
                                        <!--****INPUTS--> <input type="text" class="form-control"
                                            placeholder="first name" value="">
                                    </div>
                                    <div class="col-md-6"><label class="labels fs-6">Email</label>
                                        <!--****INPUTS--> <input type="text" class="form-control" value=""
                                            placeholder="Email">
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-6"><label class="labels fs-6">Email ID</label>
                                        <!--****INPUTS--> <input type="text" class="form-control"
                                            placeholder="Your email id" value="">
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-4"><label class="labels fs-6">Country</label>
                                        <!--****INPUTS--> <input type="text" class="form-control"
                                            placeholder="Your Country" value="">
                                    </div>
                                    <div class="col-md-4"><label class="labels fs-6">State</label>
                                        <input type="text" class="form-control" placeholder="State" value="">
                                    </div>
                                    <div class="col-md-4"><label class="labels fs-6">District</label>
                                        <input type="text" class="form-control" value="" placeholder="District">
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-12"><label class="labels fs-6">Password</label>
